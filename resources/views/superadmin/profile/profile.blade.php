...
@section('content')
    <main id="main" class="main">
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    <!-- Profile Edit Form -->
                                    <form action="/superadmin/profile/update/{{ $user->id }}" method="post"
                                        enctype="multipart/form-data" id="updateProfileSuperAdminForm-{{ $user->id }}">
                                        @csrf
                                        @method('put')
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <img src="@if ($user->photo == null) {{ URL::to('/') }}/assets/img/profile-img.jpg @else {{ asset("storage/photo-super-admin/$user->photo") }} @endif"
                                                    alt="Profile">
                                                <div class="pt-2">
                                                    <div class="row">
                                                        <div class="col">
                                        ...
                                        <div class="text-center">
                                            <button onclick="handleUpdateProfileSuperAdmin(event, {{ $user->id }})"
                                ...
                                <div class="tab-pane fade pt-3" id="profile-change-password">
                                    ...
                                    <form action="/superadmin/profile/update-pass/{{ $user->id }}" method="post"
                                        id="updatePasswordSuperAdminForm-{{ $user->id }}">
                                        @csrf
                                        @method('put')
                                        ...
                                        <div class="text-center">
                                            <button onclick="handleUpdatePasswordSuperAdmin(event, {{ $user->id }})"
        ...
        @include('superadmin.profile.profile_js')
    </main>
@endsection
