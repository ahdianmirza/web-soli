...
@section('content')
    <main id="main" class="main">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <a href="/dosenSA/add" style="margin: 20px 0 10px 0;" class="btn btn-primary btn-sm">Tambah
                                    ...
                                    @foreach ($dosenList as $item)
                                        <tr>
                                            ...
                                            <td style="text-align: center;" class="d-flex gap-2 justify-content-center">
                                                <a href="/dosenSA/edit/{{ $item->id_dosen }}" data-bs-toggle="tooltip"
                                                    data-bs-title="Edit" class="btn btn-warning btn-sm"><i
                                                        class="bi bi-pencil-square"></i></a>

                                                <form action="/dosenSA/delete/{{ $item->id_dosen }}" method="post"
                                                    id="deleteDosenSuperForm-{{ $item->id_dosen }}">
                                                    @csrf
                                                    @method('delete')

                                                    <button onclick="handleDeleteDosenSuper(event, {{ $item->id_dosen }})"
        ...
        @include('superadmin.dosen.dosen_js')
    </main>
