            ...
            <div class="section-title">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>
                            Agronomi dan Hortikultura adalah ilmu yang mempelajari pengelolaan sumberdaya nabati untuk
                            menghasilkan
                            produksi maksimum dan berkelanjutan, melalui rekayasa lingkungan dan fisiologi tanaman
                            dengan pemanfaatan
                                            ...
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab1"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                            ...
                                            <tbody>
                                                @foreach ($alat->where('id_lab', 1) as $index => $item)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">{{ $item->jumlah - $item->qty_borrow }}
                                                        </td>
                                    ...
                                    <div class="panel-body">
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab2"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab3"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                                ...
                                                @foreach ($alat->where('id_lab', 3) as $index => $item)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            {{ $item->jumlah - $item->qty_borrow }}</td>
                                                        <td class="text-center">{{ $item->kondisi_alat }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab4"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab5"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab6"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab7"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab8"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab9"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab10"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab11"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab12"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab13"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab14"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab15"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab18"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row search-container">
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab19"
                                                            placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
