...
<body class="service-page service-page-04">
        ...
        <div class="page-title-banner">
            <div class="container">
                <div class="content-wrapper">
                    <h2>Arsitektur Lanskap</h2>
                    <ul class="bread-crumb">
                        <li><a href="/">Beranda</a></li>
                        <li><a href="/faperta">Fakultas Pertanian</a></li>
                        <li><a href="/lanskap">Departemen Arsitektur Lanskap</a></li>
                    </ul>
                </div> <!-- .content-wrapper -->
            </div> <!-- .container -->
                                            ...
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab24" placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                        <table id="tableLab24" class="table corporex-table corporex-table-02">
                                                <thead>
                                                    <tr>
                                            ...
                                            <tbody>
                                                @foreach ($alat->where('id_lab', 24) as $index => $item)
                                                <tr>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row search-container">
                                                <div class="col-sm-12">
                                                    <form class="form-inline">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" id="searchLab25" placeholder="Search">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            <table id="tableLab25" class="table corporex-table corporex-table-02">
                                                <thead>
                                                    <tr>
                                                        <th class="text-center">No</th>
                                                        <th class="text-center">Nama Alat</th>
                                                ...
                                                <tbody>
                                                    @foreach ($alat->where('id_lab', 25) as $index => $item)
                                                    <tr>
                                                        <th class="text-center" scope="row">{{ $index + 1 }}</th>
                                                        <td>{{ $item->nama_alat }}</td>
                                                        <td>{{ $item->spesifikasi }}</td>
    ...
    <script>
        $(document).ready(function() {
            $("#searchLab24").on("keyup", function() {
                var value = $(this).val().toLowerCase();
                $("#tableLab24 tbody tr").filter(function() {
                    $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                });
            });

            $("#searchLab25").on("keyup", function() {
                var value = $(this).val().toLowerCase();
                $("#tableLab25 tbody tr").filter(function() {
                    $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                });
            });
