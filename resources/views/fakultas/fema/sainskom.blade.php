...
<body class="service-page service-page-04">
        ...
        <div class="page-title-banner">
            <div class="container">
                <div class="content-wrapper">
                    <h2>Departemen Sains Komunikasi dan Pengembangan Masyarakat</h2>
                    <ul class="bread-crumb">
                        <li><a href="/">Beranda</a></li>
                        <li><a href="/fema">Fakultas Ekologi Manusia</a></li>
                        <li><a href="/sainskom">Departemen Sains Komunikasi dan Pengembangan Masyarakat</a></li>
                    </ul>
                </div> <!-- .content-wrapper -->
            </div> <!-- .container -->
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion-11" href="#collapse255">
                                                    <span class="acc-num">01</span>
                                                    Studio Multimedia SKPM
                                                </a>
                                            </h4>
                                        </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <form class="form-inline">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" id="searchLab335" placeholder="Search">
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                <table id="tableLab335" class="table corporex-table corporex-table-02">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        @foreach ($alat->where('id_lab', 335) as $index => $item)
                                                        <tr>
    ...
    <script>
        $(document).ready(function() {
            $("#searchLab335").on("keyup", function() {
                var value = $(this).val().toLowerCase();
                $("#tableLab335 tbody tr").filter(function() {
