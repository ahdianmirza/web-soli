		...
		<div class="page-title-banner">
			<div class="container">
				<div class="content-wrapper">
					<h2>Fakultas Teknologi Pertanian</h2>
			...
			<div class="section-title">
				<div class="row">
					...
					<div class="img-wrapper">
						<img class="img-responsive" src="img/485515/14.png" alt="team member 01">
					</div> <!-- .img-wrapper -->
					<div class="member-info">
						<h4><a href="/itp">Departemen Ilmu dan<br>Teknologi Pangan</a></h4>
					</div> <!-- .member-info -->
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="member-info">
                            <h4><a href="/mesinbio">Departemen Teknik Mesin<br>dan Biosistem</a></h4>
                        </div> <!-- .member-info -->
                    </div> <!-- col-lg-3 col-md-6 -->
                    <div class="col-lg-3 col-md-6">
                        <div class="img-wrapper">
                            <img class="img-responsive" src="img/485515/15.png" alt="team member 01">
                        </div> <!-- .img-wrapper -->
                        <div class="member-info">
                            <h4><a href="/sipillingkungan">Departemen Teknik Sipil<br>dan Lingkungan</a></h4>
                        </div> <!-- .member-info -->
                    </div> <!-- col-lg-3 col-md-6 -->
                    <div class="col-lg-3 col-md-6">
                        <div class="img-wrapper">
                            <img class="img-responsive" src="img/485515/16.png" alt="team member 01">
                        </div> <!-- .img-wrapper -->
                        <div class="member-info">
                            <h4><a href="/industripertanian">Departemen Teknologi Industri<br>Pertanian</a></h4>
                        </div> <!-- .member-info -->
                    </div> <!-- col-lg-3 col-md-6 -->
                    </div>
                    </section>
