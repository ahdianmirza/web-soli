...
<body class="service-page service-page-04">
        ...
        <div class="page-title-banner">
            <div class="container">
                <div class="content-wrapper">
                    <h2>Departemen Pemanfaatan Sumberdaya Perikanan</h2>
                    <ul class="bread-crumb">
                        <li><a href="/">Beranda</a></li>
                        <li><a href="/fpik">Fakultas Perikanan dan Ilmu Kelautan</a></li>
                        <li><a href="/sumberdayaperikanan">Departemen Pemanfaatan Sumberdaya Perikanan</a></li>
                    </ul>
                </div> <!-- .content-wrapper -->
            </div> <!-- .container -->
                                            ...
                                            <div class="col-sm-12">
                                                <form class="form-inline">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="searchLab115" placeholder="Search">
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                        <table id="tableLab115" class="table corporex-table corporex-table-02">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                @foreach ($alat->where('id_lab', 115) as $index => $item)
                                                <tr>
                                        ...
                                        <div class="panel-body">
                                            <div class="row search-container">
                                                <div class="col-sm-12">
                                                    <form class="form-inline">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" id="searchLab116" placeholder="Search">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            <table id="tableLab116" class="table corporex-table corporex-table-02">
                                                <thead>
                                                    <tr>
                                                        <th class="text-center">No</th>
                                                        <th class="text-center">Nama Alat</th>
                                                ...
                                                <tbody>
                                                    @foreach ($alat->where('id_lab', 116) as $index => $item)
                                                        <tr>
                                                            <th class="text-center" scope="row">{{ $index + 1 }}</th>
                                                            <td>{{ $item->nama_alat }}</td>
                                                            <td>{{ $item->spesifikasi }}</td>
                                        ...
                                        <div class="panel-body">
                                            <div class="row search-container">
                                                <div class="col-sm-12">
                                                    <form class="form-inline">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" id="searchLab117" placeholder="Search">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            <table id="tableLab117" class="table corporex-table corporex-table-02">
                                                <thead>
                                                    <tr>
                                                        <th class="text-center">No</th>
                                                        <th class="text-center">Nama Alat</th>
                                                ...
                                                <tbody>
                                                    @foreach ($alat->where('id_lab', 117) as $index => $item)
                                                        <tr>
                                                            <th class="text-center" scope="row">{{ $index + 1 }}</th>
                                                            <td>{{ $item->nama_alat }}</td>
                                                            <td>{{ $item->spesifikasi }}</td>
                                        ...
                                        <div class="panel-body">
                                            <div class="row search-container">
                                                <div class="col-sm-12">
                                                    <form class="form-inline">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" id="searchLab118" placeholder="Search">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            <table id="tableLab118" class="table corporex-table corporex-table-02">
                                                <thead>
                                                    <tr>
                                                        <th class="text-center">No</th>
                                                        <th class="text-center">Nama Alat</th>
                                                ...
                                                <tbody>
                                                    @foreach ($alat->where('id_lab', 118) as $index => $item)
                                                        <tr>
                                                            <th class="text-center" scope="row">{{ $index + 1 }}</th>
                                                            <td>{{ $item->nama_alat }}</td>
                                                            <td>{{ $item->spesifikasi }}</td>
    ...
    <script>
        $(document).ready(function() {
            $("#searchLab115").on("keyup", function() {
                var value = $(this).val().toLowerCase();
                $("#tableLab115 tbody tr").filter(function() {
                    $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                });
            });

            $("#searchLab116").on("keyup", function() {
                var value = $(this).val().toLowerCase();
                $("#tableLab116 tbody tr").filter(function() {
                    $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                });
            });

            $("#searchLab117").on("keyup", function() {
                var value = $(this).val().toLowerCase();
                $("#tableLab117 tbody tr").filter(function() {
                    $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                });
            });

            $("#searchLab118").on("keyup", function() {
                var value = $(this).val().toLowerCase();
                $("#tableLab118 tbody tr").filter(function() {
                    $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                });
            });
