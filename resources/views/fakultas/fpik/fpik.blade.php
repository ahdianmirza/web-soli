		...
		<div class="page-title-banner">
			<div class="container">
				<div class="content-wrapper">
					<h2>Fakultas Perikanan dan Ilmu Kelautan</h2>
			...
			<div class="section-title">
				<div class="row">
					...
					<div class="img-wrapper">
						<img class="img-responsive" src="img/485515/5.png" alt="team member 01">
					</div> <!-- .img-wrapper -->
					<div class="member-info">
						<h4><a href="/sumberdayaperikanan">Departemen Pemanfaatan <br> Sumberdaya Perikanan</a></h4>
					</div> <!-- .member-info -->
				</div> <!-- col-lg-3 col-md-6 -->
				<div class="col-lg-3 col-md-6">
					<div class="img-wrapper">
						<img class="img-responsive" src="img/485515/6.png" alt="team member 01">
					</div> <!-- .img-wrapper -->
					<div class="member-info">
						<h4><a href="/budidayaperairan">Departemen Budidaya<br>Perairan</a></h4>
					</div> <!-- .member-info -->
				</div> <!-- col-lg-3 col-md-6 -->
				<div class="col-lg-3 col-md-6">
					<div class="img-wrapper">
						<img class="img-responsive" src="img/485515/7.png" alt="team member 01">
					</div> <!-- .img-wrapper -->
					<div class="member-info">
						<h4><a href="/sumberdayaperairan">Departemen Manajemen<br>Sumberdaya Perairan</a></h4>
					</div> <!-- .member-info -->
				</div> <!-- col-lg-3 col-md-6 -->
				<div class="col-lg-3 col-md-6">
					<div class="img-wrapper">
						<img class="img-responsive" src="img/485515/8.png" alt="team member 01">
					</div> <!-- .img-wrapper -->
					<div class="member-info">
						<h4><a href="/itk">Departemen ITK</a></h4>
					</div> <!-- .member-info -->
				</div> <!-- col-lg-3 col-md-6 -->
                <div class="col-lg-3 col-md-6">
					<div class="img-wrapper">
						<img class="img-responsive" src="img/485515/9.png" alt="team member 01">
					</div> <!-- .img-wrapper -->
					<div class="member-info">
						<h4><a href="/hasil_perairan">Departemen Teknologi<br>Hasil Perairan</a></h4>
					</div> <!-- .member-info -->
				</div> <!-- col-lg-3 col-md-6 -->
				</div>
				</section>
