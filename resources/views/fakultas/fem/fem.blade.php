	...
	<section class="hero-area">
		<div class="page-title-banner">
			<div class="container">
                ...
                <h2>Fakultas Ekonomi dan Manajemen</h2>
					<ul class="bread-crumb">
						<li><a href="/">Beranda</a></li>
                        <li><a href="/fem">Fakultas Ekonomi dan Manajemen</a></li>
					</ul>
				</div> <!-- .content-wrapper -->
			</div> <!-- .container -->
			...
			<div class="section-title">
				<div class="row">
					...
					<div class="img-wrapper">
						<img class="img-responsive" src="img/485515/25.png" alt="team member 01">
					</div> <!-- .img-wrapper -->
					<div class="member-info">
						<h4><a href="/agribisnis">Departemen Agribisnis</a></h4>
					</div> <!-- .member-info -->
				</div> <!-- col-lg-3 col-md-6 -->
				<div class="col-lg-3 col-md-6">
					<div class="img-wrapper">
						<img class="img-responsive" src="img/485515/28.png" alt="team member 01">
					</div> <!-- .img-wrapper -->
					<div class="member-info">
						<h4><a href="/ekonomi">Departemen Ilmu Ekonomi</a></h4>
					</div> <!-- .member-info -->
				</div> <!-- col-lg-3 col-md-6 -->
				<div class="col-lg-3 col-md-6">
					<div class="img-wrapper">
						<img class="img-responsive" src="img/485515/26.png" alt="team member 01">
					</div> <!-- .img-wrapper -->
					<div class="member-info">
						<h4><a href="/ekonomisdl">Departemen Ekonomi Sumberdaya dan Lingkungan</a></h4>
					</div> <!-- .member-info -->
				</div> <!-- col-lg-3 col-md-6 -->
				<div class="col-lg-3 col-md-6">
					<div class="img-wrapper">
						<img class="img-responsive" src="img/485515/27.png" alt="team member 01">
					</div> <!-- .img-wrapper -->
					<div class="member-info">
						<h4><a href="/ekonomisyariah">Departemen Ilmu Ekonomi Syariah</a></h4>
					</div> <!-- .member-info -->
				</div> <!-- col-lg-3 col-md-6 -->
                <div class="col-lg-3 col-md-6">
					<div class="img-wrapper">
						<img class="img-responsive" src="img/485515/29.png" alt="team member 01">
					</div> <!-- .img-wrapper -->
					<div class="member-info">
						<h4><a href="/manajemen">Departemen Manajemen</a></h4>
					</div> <!-- .member-info -->
				</div> <!-- col-lg-3 col-md-6 -->
				</div>
				</section>
