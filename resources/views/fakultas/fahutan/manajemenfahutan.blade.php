...
<body class="service-page service-page-04">
        ...
        <div class="page-title-banner">
            <div class="container">
                <div class="content-wrapper">
                    <h2>Departemen Manajemen Hutan Fakultas Kehutanan dan Lingkungan</h2>
                    <ul class="bread-crumb">
                        <li><a href="/">Beranda</a></li>
                        <li><a href="/fahutan">Fakultas Kehutanan dan Lingkungan </a></li>
                        <li><a href="/manajemenfahutan">Departemen Manajemen Hutan Fakultas Kehutanan dan Lingkungan</a></li>
                    </ul>
                </div> <!-- .content-wrapper -->
            </div> <!-- .container -->
                            ...
                            <div class="col-md-12">
                                <div class="panel-group corporex-accordion accordion-style-03 has-num" id="accordion-11">
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" href="#collapse171">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <form class="form-inline">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" id="searchLab255" placeholder="Search">
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                <table id="tableLab255" class="table corporex-table corporex-table-02">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        @foreach ($alat->where('id_lab', 255) as $index => $item)
                                                        <tr>
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" href="#collapse172">
                                                    <span class="acc-num">02</span>
                                                    Lab. Inventarisasi SDH
                                                </a>
                                            </h4>
                                        </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row search-container">
                                                    <div class="col-sm-12">
                                                        <form class="form-inline">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" id="searchLab256" placeholder="Search">
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                <table id="tableLab256" class="table corporex-table corporex-table-02">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center">No</th>
                                                            <th class="text-center">Nama Alat</th>
                                                    ...
                                                    <tbody>
                                                        @foreach ($alat->where('id_lab', 256) as $index => $item)
                                                        <tr>
                                                            <th class="text-center" scope="row">{{ $index + 1 }}</th>
                                                            <td>{{ $item->nama_alat }}</td>
                                                            <td>{{ $item->spesifikasi }}</td>
    ...
    <script>
        $(document).ready(function() {
            $("#searchLab255").on("keyup", function() {
                var value = $(this).val().toLowerCase();
                $("#tableLab255 tbody tr").filter(function() {
                    $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                });
            });

            $("#searchLab256").on("keyup", function() {
                var value = $(this).val().toLowerCase();
                $("#tableLab256 tbody tr").filter(function() {
                    $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                });
            });
