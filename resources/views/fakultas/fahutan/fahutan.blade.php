		...
		<div class="page-title-banner">
			<div class="container">
				<div class="content-wrapper">
					<h2>Fakultas Kehutanan dan Lingkungan </h2>
			...
			<div class="section-title">
				<div class="row">
					...
					<div class="img-wrapper">
						<img class="img-responsive" src="img/485515/10.png" alt="team member 01">
					</div> <!-- .img-wrapper -->
					<div class="member-info">
						<h4><a href="/hasilhutan">Departemen Hasil Hutan</a></h4>
					</div> <!-- .member-info -->
                    </div> <!-- col-lg-3 col-md-6 -->
                    <div class="col-lg-3 col-md-6">
                        <div class="img-wrapper">
                            <img class="img-responsive" src="img/485515/11.png" alt="team member 01">
                        </div> <!-- .img-wrapper -->
                        <div class="member-info">
                            <h4><a href="/silvikultur">Departemen Silvikultur</a></h4>
                        </div> <!-- .member-info -->
                    </div> <!-- col-lg-3 col-md-6 -->
                    <div class="col-lg-3 col-md-6">
                        <div class="img-wrapper">
                            <img class="img-responsive" src="img/485515/12.png" alt="team member 01">
                        </div> <!-- .img-wrapper -->
                        <div class="member-info">
                            <h4><a href="/sdhekowisata">Departemen Konservasi Sumberdaya<br>Hutan dan Ekowisata</a></h4>
                        </div> <!-- .member-info -->
                    </div> <!-- col-lg-3 col-md-6 -->
                    <div class="col-lg-3 col-md-6">
                        <div class="img-wrapper">
                            <img class="img-responsive" src="img/485515/13.png" alt="team member 01">
                        </div> <!-- .img-wrapper -->
                        <div class="member-info">
                            <h4><a href="/manajemenfahutan">Departemen Manajemen Hutan</a></h4>
                        </div> <!-- .member-info -->
                    </div> <!-- col-lg-3 col-md-6 -->
                    </div>
                    </section>
