			...
			<div class="section-title">
				<div class="row">
					...
					<div class="img-wrapper">
						<img class="img-responsive" src="img/485515/22.png" alt="team member 01">
					</div> <!-- .img-wrapper -->
					<div class="member-info">
						<h4><a href="/geofisikameo">Departemen Geofisika<br>dan Meteorologi </a></h4>
					</div> <!-- .member-info -->
                    </div> <!-- col-lg-3 col-md-6 -->
                    <div class="col-lg-3 col-md-6">
                        <div class="img-wrapper">
                            <img class="img-responsive" src="img/485515/19.png" alt="team member 01">
                        </div> <!-- .img-wrapper -->
                        <div class="member-info">
                            <h4><a href="/biologi">Departemen Biologi</a></h4>
                        </div> <!-- .member-info -->
                    </div> <!-- col-lg-3 col-md-6 -->
                    <div class="col-lg-3 col-md-6">
                        <div class="img-wrapper">
                            <img class="img-responsive" src="img/485515/24.png" alt="team member 01">
                        </div> <!-- .img-wrapper -->
                        <div class="member-info">
                            <h4><a href="/kimia">Departemen Kimia</a></h4>
                        </div> <!-- .member-info -->
                    </div> <!-- col-lg-3 col-md-6 -->
                    <div class="col-lg-3 col-md-6">
                        <div class="img-wrapper">
                            <img class="img-responsive" src="img/485515/23.png" alt="team member 01">
                        </div> <!-- .img-wrapper -->
                        <div class="member-info">
                            <h4><a href="/ilkom">Departemen Ilmu<br>Komputer</a></h4>
                        </div> <!-- .member-info -->
                    </div> <!-- col-lg-3 col-md-6 -->
                    <div class="col-lg-3 col-md-6">
                        <div class="img-wrapper">
                            <img class="img-responsive" src="img/485515/21.png" alt="team member 01">
                        </div> <!-- .img-wrapper -->
                        <div class="member-info">
                            <h4><a href="/fisika">Departemen Fisika</a></h4>
                        </div> <!-- .member-info -->
                    </div> <!-- col-lg-3 col-md-6 -->
                    <div class="col-lg-3 col-md-6">
                        <div class="img-wrapper">
                            <img class="img-responsive" src="img/485515/20.png" alt="team member 01">
                        </div> <!-- .img-wrapper -->
                        <div class="member-info">
                            <h4><a href="/biokimia">Departemen Biokimia</a></h4>
                        </div> <!-- .member-info -->
                    </div> <!-- col-lg-3 col-md-6 -->
                    </div>
                    </section>
